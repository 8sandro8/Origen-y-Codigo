...
<head>
    ...
    <title>Nueva Categoría - Origen &amp; Código</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="card shadow-sm p-4">
                    ...
                    <form action="${pageContext.request.contextPath}/add-categoria" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="${pageContext.request.contextPath}/list-categorias" class="btn btn-secondary">
                                Cancelar
                            </a>
                        </div>
                    </form>
