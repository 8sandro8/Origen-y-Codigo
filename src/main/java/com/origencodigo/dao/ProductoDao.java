...
public interface ProductoDao extends SqlObject {
    ...
    int add(@Bind("categoriaId") int categoriaId, @Bind("nombre") String nombre, @Bind("descripcion") String descripcion, @Bind("precio") java.math.BigDecimal precio, @Bind("origen") String origen, @Bind("imagenUrl") String imagenUrl, @Bind("stockDisponible") boolean stockDisponible);
    ...
    int update(@Bind("id") int id, @Bind("categoriaId") int categoriaId, @Bind("nombre") String nombre, @Bind("descripcion") String descripcion, @Bind("precio") java.math.BigDecimal precio, @Bind("origen") String origen, @Bind("imagenUrl") String imagenUrl, @Bind("stockDisponible") boolean stockDisponible);
